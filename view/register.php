		...
		<div class="main-agileits">
				<div class="form-w3agile form1">
					...
					<form action="../actions/registerprocess.php" method="post">
						...
						<div class="key">
							<i class="fa fa-lock" aria-hidden="true"></i>
							<input  type="password" value="Confirm Password" name="pass_2"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Confirm Password';}" required="" >
							<div class="clearfix"></div>
						</div>
						...
						<div class="key">
							...
							<input  type="text" value="Enter phone number" name="contact"  onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Phone';}" required="" >
							<div class="clearfix"></div>
						</div>
