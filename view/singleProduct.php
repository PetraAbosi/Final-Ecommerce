...
<div class="banner-top">
	<div class="container">
		...
		<h4><a href="index.php">Home</a><label>/</label>Product Details</h4>
		<div class="clearfix"> </div>
	</div>
</div>
		<div class="single">
...
<div id="picture-frame">
            ...
            ?>
            <img src="<?php echo $product_image ?>" alt="product" srcset="" width="250" height="300">
			...
			<div class="col-md-7 single-top-left ">
				...
				<ul class="social-top">
                 ...
                 <div>
				 		...
				 		<input type="number" name='qty' value="1" placeholder="Quantity">
